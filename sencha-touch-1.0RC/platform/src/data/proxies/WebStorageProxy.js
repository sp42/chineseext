 ...
 * 
 * <p>
 * WebStorageProxy是{@link Ext.data.LocalStorageProxy localStorage}及{@link Ext.data.SessionStorageProxy sessionStorage} 的基类，
 * 它使用了HTML5新型的ley/value客户端存储方案来保存{@link Ext.data.Model model instances}，达到离线存储之目的。
 ...
 * 
 * @constructor
 * 创建proxy，如果浏览器不支持HTML5客户端存储方案，就立刻抛出一个异常。
