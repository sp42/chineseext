 ...
 */
     ...
     * 展开这个节点。
     * Expand this node.
     * @param {Boolean} deep 如果为true展开所有的子节点。(optional)True to expand all children as well
     * @param {Boolean} anim 如果为false不启用动画效果。(optional)false to cancel the default animation
     ...
     * 展开该节点。
     * Collapse this node.
     * @param {Boolean} deep 为true则也展开所有的子结点。(optional)True to collapse all children as well
     * @param {Boolean} anim 如果为false不启用动画效果。(optional)false to cancel the default animation
     */
