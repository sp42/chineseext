   ...
   /**
    ...
    initComponent : function(){
        ...
        this.addEvents(
             ...
             * 当autosize函数调用时触发。根据缺省的逻辑，字段有可能不会真正地改变大小，但该事件的目的至于，允许开发人员在运行时加入额外的逻辑，以备调整输入字段的大小。
             * @param {Ext.form.Field} this This text field 文本输入字段
             ...
             * @param {Ext.form.TextField} this This text field 文本输入字段
