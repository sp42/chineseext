...
Ext.extend(Ext.form.BasicForm, Ext.util.Observable, {
   /**
    ...
    activeAction : null,
     ...
     /**
     * @cfg {Boolean} trackResetOnLoad 如果为true，表单对象的form.reset()方法重置到最后一次加载或setValues()数据，
     * 
     */
   ...
   /**
    ...
    /**
     * 做提交动作的简便方法。
     * @param {Object} options 传递给动作对象的选项配制 (请见 {@link #doAction} )
     * @return {BasicForm} this
     */
   ...
   /**
     * 可以批量的标记表单元素为失效的。
     * @param {Array/Object} errors 即可以是像这样的 [{id:'fieldId', msg:'The message'},...] 数组，也可以是像这样 {id: msg, id2: msg2} 的一个HASH结构对象。
     * @return {BasicForm} this
     */
   ...
   /**
     * 表单元素批量赋值。
     * @param {Array/Object} values 即可以是像这样的 [{id:'fieldId', value:'foo'},...] 数组，也可以是像这样 {id: value, id2: value2} 的一个HASH结构对象。
     * @return {BasicForm} this
     */
